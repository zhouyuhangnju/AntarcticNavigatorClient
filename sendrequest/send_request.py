...
class PointWindow(Frame):
    def __init__(self, master):
        ...
        self.label_leftlon = Label(self.frame_range, text='经度西界:')
        ...
        self.label_leftlat = Label(self.frame_range, text='纬度北界:')
        ...
        self.label_rightlon = Label(self.frame_range, text='经度东界:')
        ...
        self.label_rightlat = Label(self.frame_range, text='纬度南界:')
